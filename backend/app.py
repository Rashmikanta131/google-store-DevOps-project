...
def build_order_receipt(order_payload):
    ...
    <div style="font-family:Arial,sans-serif;max-width:760px;margin:0 auto;padding:24px;color:#202124;">
      ...
      <p>Your order <strong>#{order_payload['id']}</strong> has been placed successfully on akki.</p>
...
def login_request():
    ...
    try:
        ...
        msg.body = f"Hi, welcome to Multicloud DevOps by Veera Sir Naresh IT  Your login OTP for our ecommerce website  {otp}. It expires in 5 minutes."
        mail.send(msg)
